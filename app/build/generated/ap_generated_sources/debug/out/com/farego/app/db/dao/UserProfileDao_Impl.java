...
public final class UserProfileDao_Impl implements UserProfileDao {
  ...
  public UserProfileDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserProfile = new EntityInsertionAdapter<UserProfile>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `user_profiles` (`id`,`user_id`,`name`,`email`,`phone`,`avatar_path`,`home_location`,`work_location`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.avatarPath == null) {
          ...
          statement.bindString(6, entity.avatarPath);
        }
        if (entity.homeLocation == null) {
          statement.bindNull(7);
        } else {
          statement.bindString(7, entity.homeLocation);
        }
        if (entity.workLocation == null) {
          statement.bindNull(8);
        } else {
          statement.bindString(8, entity.workLocation);
        }
      }
    };
    this.__preparedStmtOfDeleteByUserId = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM user_profiles WHERE user_id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void upsert(final UserProfile profile) {
  ...
  @Override
  public UserProfile getByUserId(final int userId) {
    final String _sql = "SELECT * FROM user_profiles WHERE user_id = ? LIMIT 1";
    ...
    try {
      ...
      final int _cursorIndexOfHomeLocation = CursorUtil.getColumnIndexOrThrow(_cursor, "home_location");
      final int _cursorIndexOfWorkLocation = CursorUtil.getColumnIndexOrThrow(_cursor, "work_location");
      ...
      if (_cursor.moveToFirst()) {
        ...
        if (_cursor.isNull(_cursorIndexOfAvatarPath)) {
          _result.avatarPath = null;
        } else {
          _result.avatarPath = _cursor.getString(_cursorIndexOfAvatarPath);
        }
        if (_cursor.isNull(_cursorIndexOfHomeLocation)) {
          _result.homeLocation = null;
        } else {
          _result.homeLocation = _cursor.getString(_cursorIndexOfHomeLocation);
        }
        if (_cursor.isNull(_cursorIndexOfWorkLocation)) {
          _result.workLocation = null;
        } else {
          _result.workLocation = _cursor.getString(_cursorIndexOfWorkLocation);
        }
      } else {
        _result = null;
      }
